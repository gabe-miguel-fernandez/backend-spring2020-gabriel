...
const dbULR = "mongodb+srv://notesScriptUser:notesScriptUserPassword@cluster0-ersfa.mongodb.net/todoScript?retryWrites=true&w=majority";
const dbOptions = {
...
mongoose.connect(dbULR, dbOptions, (error) => {
    if (error) {
        console.log("Mongoose received an error!");
    } else {
